...
if __name__ == '__main__':
    ...
    #
    state_dic = model.load_states("Status_Folder/My_status_v71AAremoved_Adipose_v3.csv", format = 'csv')
    model.set_constraints_from_state_dict(state_dic)
    model.update()
    carbon_ratio = pd.read_csv('Tissue_Carbon_Source_v2.csv', index_col=0)

    source_dir1 = 'D:/mfapyt/sample/MDV_Tissue/Adipose/'
    dest_dir1 = 'D:/mfapyt/sample/Results_Tissue/Adipose/'
