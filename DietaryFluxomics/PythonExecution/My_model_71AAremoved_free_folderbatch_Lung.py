...
if __name__ == '__main__':
    ...
    #
    state_dic = model.load_states("My_status_v71AAremoved_Lung.csv", format = 'csv')
    model.set_constraints_from_state_dict(state_dic)
    model.update()
    carbon_ratio = pd.read_csv('Tissue_Carbon_Source_v2.csv', index_col=0)

    source_dir1 = 'D:/mfapyt/sample/MDV_Tissue/Lung/'
    dest_dir1 = 'D:/mfapyt/sample/Results_Tissue/Lung/'
